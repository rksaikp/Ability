...
const data = [
    {key: 1, title: "Jayshree Raveendran", role: "Founder and Managing Trustee", img: img1},
    {key: 2, title: "Leela Swamy", role: "Educationist & Academician", img: img2},
    {key: 3, title: "Dr. M. Thangavelu", role: "Former Regional Director (WHO)", img: img3},
    {key: 4, title: "CK Ranganathan", role: "Chairman & Managing Director – CavinKare (P) Ltd", img: img4},
    {key: 5, title: "Revathy", role: "Actor/Director/Activist", img: img5},
    {key: 6, title: "Ishwar Achanta", role: "President", img: img6},
    {key: 7, title: "S. Krishnaswamy", role: "Advisor", img: img7},
    {key: 8, title: "Janaki Pillai", role: "Director (Programmes)", img: img8},
    {key: 9, title: "Bharathi Sekhar", role: "Director (Operations)", img: img9},
]

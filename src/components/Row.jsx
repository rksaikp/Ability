...
function Row({ translateClass, direction }) {
    ...
    const items = [
        { text: "Our mission", image: img7 },
        { text: "Our vision", image: img2 },     
        { text: "New Talents", image: img3 },     
        { text: "Events", image: img4 },     
        { text: "Empowerment Programs", image: img5 },
        { text: "Awareness Campaigns", image: img2 },
        { text: "Access to Education", image: img4 },     
        { text: "Employment Initiatives", image: img5 },

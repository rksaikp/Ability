        ...
        <div className="left sm:w-1/3 h-full flex flex-col sm:justify-between py-10 items-start " >
            ...
            *Empowerment Programs
            ...
            <div className="heading">
                <h1 className="font-[SansitaReg] text-[5vh] leading-[6.5vh] sm:text-[8vh] py-5 sm:leading-[9vh]">Explore </h1>
                <Button bgColor="bg-[#f5f19c]" text="VIEW ALL" />
            </div>
        </div>
        <div className=" right font-[SansitaReg] mt-10 sm:w-2/3 space-y-10 h-full sm:flex items-start justify-start sm:gap-20  ">
            ...
            <div   
                ...
                <div className="text text-center text-[6vw] sm:text-[3.2vh] font-semibold mt-10 leading-[4.8vh]">
                    <h3>Our work is rooted in the belief that people with disabilities are integral to the richness of diversity.
                    </h3>
                </div>
                <button className="bg-[#e9bbff] text-black px-4 rounded-full text-medium py-3 mb-10 mt-10 font-semibold">Empowerment</button>
            ...
            >
                ...
                <div className="text text-center text-[3.2vh] flex flex-col gap-6 mb-6 font-semibold leading-[4.8vh]">
                    <h3>To advocate for equal opportunities for individuals with disabilities, facilitating their integration into mainstream society.
                    </h3>
                    <h4 className="font-[Sansita] text-[1.9vh] font-medium leading-[2.8vh] text-zinc-500">To foster attitudinal changes in society regarding individuals with disabilities, challenging and transforming public stereotypes and perceptions. 
                    </h4>
                </div>
                <div className="image w-[74vw] h-[74vw] sm:w-[40vh] sm:h-[40vh]  rounded-full overflow-hidden">

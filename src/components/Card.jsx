...
function Card() {
    ...
    const items = [
        { 
            title: "Our Mission", 
            description: "Support initiatives that enable full integration and participation for everyone in mainstream society.",
        ...
        { 
            title: "Our Mission", 
            description: "Empowering Unique Talents: Recognize and cultivate individual talents, maximizing the utilization of diverse skills and abilities.",
            image: `<svg width="100%" height="100%" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        { 
            title: "Our Mission", 
            description: "Shifting Perceptions: Encourage positive societal attitudes and foster understanding, challenging and transforming outdated stereotypes.",
            image: `<svg width="100%" height="100%" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        { 
            title: "Our Vision", 
            description: "A society where people of all abilities walk together as equals, work side by side, and are valued as partners; where support is given with empathy, not out of sympathy.",
            image: `<svg width="100%" height="100%" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">

...
Together, We Break Barriers & Embrace Diversity
Creating a future where every person can achieve their fullest potential.
                    </h3>
                    ...
                    <h3 className=' text-[2vh] sm:text-[5vh] font-semibold sm:leading-[7vh]'>
                        Real People — real Heros — Real Lives Inspiring us.
                    </h3>    
                </div>
                <div 
            ...
            >
                ...
                <div className='w-[60%] text-center font-[SansitaReg] relative'>
                    ...
                    >
                        At Ability Foundation, our passion has always been to bridge the gap between people with and without disabilities while raising awareness across society. With this goal in mind, AbilityFest – a celebration through cinema – was born..
                    </h3>
                    <h1 className=' font-semibold text-[10vh] sm:text-[20vh] leading-none text-white'>
                        49%
                    </h1>

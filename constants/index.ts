...
export const clientsItem = [
   {
      ...
      href: "/",
      title: "Founder",
      name: "Jayshree Raveendran",
      src: client01,
      review: "Ability Foundation is dedicated to empowering individuals with disabilities by promoting equal opportunities, fostering inclusion, and advocating for their rights to create a barrier-free, inclusive society",
      links: [
   ...
   },
   {
      ...
      website: "Trustee",
      href: "/",
      title: "Former Regional Director (WHO)",
      name: "Dr. M. Thangavelu",
      src: client03,
      review: "Ability Foundation is dedicated to empowering individuals with disabilities by promoting equal opportunities, fostering inclusion, and advocating for their rights to create a barrier-free, inclusive society",
      links: [
